...
5. FORMATTING: Do NOT use the '#' character for headings or formatting. Use bullet points for sections like "Top Themes", "User Quotes", and "Actionable Next Steps" instead.
"""
